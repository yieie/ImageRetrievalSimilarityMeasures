...
## 正規化
<img width="600px" src="readme/Normalization.svg"/>  

### Remove_Unuseful_Column.py
移除原dataset中無用的欄位，僅保留特徵、檔案名、類別名，分別保存到`removed_unuseful_column_data`資料夾中。  
### Mix_Dataset.py  
將50個dataset根據檔案名a~z合併成一個完整dataset `fullset_original.txt`。  
### Normalization.py  
